            ...
            <div style="flex-grow: 1; padding: 20px; background-color: #f5f6fa;">
                    ...
                    <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
                        <form method="GET" action="book.jsp" style="display: flex; gap: 10px;">
                            ...
                            <button type="submit" style="background-color: #7f8c8d; color: white; border: none; padding: 8px; border-radius: 4px; cursor: pointer;">Filter</button>
                        </form>
                    </div>
                        ...
                        <table style="width: 100%; border-collapse: collapse;">
                            ...
                            <tbody>
                                ...
                                if (searchQuery != null && !searchQuery.trim().isEmpty()) {
                                    bookList = books.searchBooks(searchQuery);
                                } else {
                            ...
                            %>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 12px; border-bottom: 1px solid #ddd;">
                                        <span style="background-color: #2ecc71; color: white; padding: 4px 8px; border-radius: 4px;"><%= list.getStatus()%></span>
                                    </td>
                                    <td style="padding: 12px; border-bottom: 1px solid #ddd;">
