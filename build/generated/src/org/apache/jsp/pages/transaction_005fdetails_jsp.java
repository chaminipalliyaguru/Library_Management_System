...
public final class transaction_005fdetails_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\n");
      out.write("    <head>\n");
      out.write("        <title>Transaction Details - Library Management System</title>\n");
      out.write("    </head>\n");
    ...
    String adminPhoto = "../images/admin_photo.png"; // Ensure this image is in your project directory
      ...
      out.write("                    <h2 style=\"margin: 0;\">Transaction Details</h2>\n");
      ...
      out.write("                        <div>\n");
      out.write("                            <label style=\"display: block; font-weight: bold; margin-bottom: 5px;\">Transaction ID:</label>\n");
      out.write("                            <p style=\"background-color: #f5f5f5; padding: 10px; border: 1px solid #ddd; border-radius: 4px;\">T001</p>\n");
      out.write("                        </div>\n");
      out.write("\n");
      out.write("                        <!-- User ID -->\n");
      out.write("                        <div>\n");
      out.write("                            <label style=\"display: block; font-weight: bold; margin-bottom: 5px;\">User ID:</label>\n");
      out.write("                            <p style=\"background-color: #f5f5f5; padding: 10px; border: 1px solid #ddd; border-radius: 4px;\">U001</p>\n");
      out.write("                        </div>\n");
      out.write("\n");
      out.write("                        <!-- Book ID -->\n");
      out.write("                        <div>\n");
      out.write("                            <label style=\"display: block; font-weight: bold; margin-bottom: 5px;\">Book ID:</label>\n");
      out.write("                            <p style=\"background-color: #f5f5f5; padding: 10px; border: 1px solid #ddd; border-radius: 4px;\">B001</p>\n");
      out.write("                        </div>\n");
      out.write("\n");
      out.write("                        <!-- Quantity -->\n");
      out.write("                        <div>\n");
      out.write("                            <label style=\"display: block; font-weight: bold; margin-bottom: 5px;\">Quantity:</label>\n");
      out.write("                            <p style=\"background-color: #f5f5f5; padding: 10px; border: 1px solid #ddd; border-radius: 4px;\">1</p>\n");
      out.write("                        </div>\n");
      out.write("\n");
      out.write("                        <!-- Transaction Date -->\n");
      out.write("                        <div>\n");
      out.write("                            <label style=\"display: block; font-weight: bold; margin-bottom: 5px;\">Transaction Date:</label>\n");
      out.write("                            <p style=\"background-color: #f5f5f5; padding: 10px; border: 1px solid #ddd; border-radius: 4px;\">2025-01-01</p>\n");
      out.write("                        </div>\n");
      out.write("\n");
      out.write("                        <!-- Status -->\n");
      out.write("                        <div>\n");
      out.write("                            <label style=\"display: block; font-weight: bold; margin-bottom: 5px;\">Status:</label>\n");
      out.write("                            <p style=\"background-color: #f5f5f5; padding: 10px; border: 1px solid #ddd; border-radius: 4px;\">Borrowed</p>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
