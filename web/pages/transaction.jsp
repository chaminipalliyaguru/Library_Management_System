<%-- 
    ...
    Created on : Jan 1, 2025, 2:51:04 PM
    Author     : User
--%>
    ...
    <div style="display: flex; min-height: calc(100vh - 120px);">
        ...
        <div style="flex-grow: 1; padding: 20px; background-color: #f5f6fa;">
            <div style="display: flex; justify-content: space-between; margin-bottom: 20px;">
                ...
                <button style="background-color: #3498db; color: white; border: none; padding: 10px 20px; border-radius: 4px; cursor: pointer;">New Transaction</button>
            </div>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <thead>
                        <tr style="background-color: #f8f9fa;">
                            ...
                            <th style="padding: 12px; text-align: left; border-bottom: 2px solid #ddd;">Book</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="padding: 12px; border-bottom: 1px solid #ddd;">Borrow</td>
